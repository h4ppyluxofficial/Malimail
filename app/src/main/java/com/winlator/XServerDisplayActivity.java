...
public class XServerDisplayActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (navItemId == R.id.menu_item_keyboard) {
        ...
        else if (navItemId == R.id.menu_item_toggle_fullscreen) {
            renderer.toggleFullscreen();
            drawerLayout.closeDrawers();
        }
        else if (navItemId == R.id.menu_item_task_manager) {
            (new TaskManagerDialog(this)).show();
            drawerLayout.closeDrawers();
        }
        else if (navItemId == R.id.menu_item_active_windows) {
            (new ActiveWindowsDialog(this)).show();
            drawerLayout.closeDrawers();
        }
        else if (navItemId == R.id.menu_item_magnifier) {
        ...
        else if (navItemId == R.id.menu_item_screen_effect) {
            (new ScreenEffectDialog(this)).show();
            drawerLayout.closeDrawers();
        }
        else if (navItemId == R.id.menu_item_pip_mode) {
        ...
        else if (navItemId == R.id.menu_item_logs) {
            debugDialog.show();
            drawerLayout.closeDrawers();
        }
        else if (navItemId == R.id.menu_item_touchpad_help) {
            showTouchpadHelpDialog();
        }
        else if (navItemId == R.id.menu_item_exit) {
            exit();
        }
        return true;
    }
